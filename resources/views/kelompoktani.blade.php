                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-3 col-xl-3 mb-4 mb-lg-0">
                                        <div class="bg-image hover-zoom ripple rounded ripple-surface">
                                            <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.blog.eriknerum.com%2Fwp-content%2Fuploads%2F2014%2F05%2Fsayursayuran.jpg&f=1&nofb=1&ipt=c28c8b7bddbd91505e25c6ece87eff056cb7161bbb43037821e54ca0234da71f&ipo=images"
                                                class="w-100" />
                                            <a href="#!">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-6">
                                        <h5>Kelompok Tani Srimulyo</h5>
                                        <p class="text-truncate mb-4 mb-md-0">
                                            Jawa Timur
                                            Semua Olahan dari Buah Kelapa
                                        </p>
                                    </div>
                                    <div class="col-md-6 col-lg-3 col-xl-3 border-sm-start-none border-start">
                                        <div class="d-flex flex-column mt-4">
                                            <button class="btn btn-primary btn-sm" type="button">List Sayuran</button>
                                            <button class="btn-sign-in" type="button">Hubungi Melalui Whatsapp</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card shadow-0 border rounded-3">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-6">
                                        <h5>Kelompok Tani Buah Kelapa</h5>
                                        <p class="text-truncate mb-4 mb-md-0">
                                            Jawa Timur
                                            Semua Olahan dari Buah Kelapa
                                        </p>
                        ...
                        <div class="card shadow-0 border rounded-3">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-6">
                                        <h5>Kelompok Tani Buah</h5>
                                        <p class="text-truncate mb-4 mb-md-0">
                                            Jawa Timur
                                            Semua Olahan dari Buah 
                                        </p>
                                    </div>
                                    <div class="col-md-6 col-lg-3 col-xl-3 border-sm-start-none border-start">
                                        <div class="d-flex flex-column mt-4">
